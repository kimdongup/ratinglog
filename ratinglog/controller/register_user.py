...
@ratinglog.route('/user/regist', methods=['POST'])
def register_user():
    """포토로그 사용자 등록을 위한 함수"""
...
@ratinglog.route('/user/<username>', methods=['POST'])
@login_required
...
@ratinglog.route('/user/check_name', methods=['POST'])
def check_name():
